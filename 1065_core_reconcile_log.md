...
| 7 | Net farm profit on **page-1 line 5** → total income → ordinary income → K1 (`p1_5_net_farm`; face f1065 line 5) | `compute.py:287`: `("K11", F34)` — routes Schedule F net to **Schedule K line 11** (other income), not page-1 line 5 | ⚠ **ROUTING DIVERGENCE** (substantive) | **Ken (farm/depreciation specialty):** is partnership net farm page-1 ordinary income (face line 5, in the SE base via K1) or separately stated on Sch K line 11? Check for double-count if page-1 field "5" is also populated. |
