...
SCOPE: this spec applies the §1402(a)(13) classification to the SE base; it does NOT define
the base (the i1065 worksheet lines 1a-3a Form-4797/rental adjustments — spec §14, a
separate sub-spec). Spec-first: nothing in tts-tax-app is touched here. Job ends at a
fetchable RS export.
"""
...
READY_TO_SEED = True  # Tax law LOCKED by Ken 2026-07-01; this loader is a faithful translation.
...
AUTHORITY_SOURCES: list[dict] = [
    ...
    # ── 7. IRS SE Worksheet (i1065 2025, p.45) — the mechanical computation home ──
    {
        ...
        "notes": "The IRS SE Worksheet already encodes Decisions 3 & 4 verbatim (line 3b removes limited "
                 ...
                 "4c; entity line 14a = 3c + 4c). Our spec's ONE addition: substitute the functional-"
                 "analysis se_classification for the worksheet's mechanical 'limited partner' label at "
                 "3b/4b. REQUIRES HUMAN REVIEW: confirm p.45 line refs against the final 2025 i1065.",
        "topics": ["se_1402_partner"],
        "excerpts": [
            {
                "excerpt_label": "SE Worksheet base (lines 1a-3a)",
                "location_reference": "i1065 (2025) p.45, SE Worksheet lines 1a-3a",
                "excerpt_text": (
                    "base = Sch K line 1 (1a) + certain rental RE, dealer/substantial-services only (1b) "
                    "+ other net rental / Sch K line 3c (1c) + Form 4797 Part II loss (1d) - Form 4797 "
                    "Part II gain (2) = line 3a."
                ),
                "summary_text": "The ordinary-income SE base (NOT defined by this spec — §14 sub-spec): raw "
                                "box 1 plus the conditional rental inclusions and the Form 4797 Part II "
                                "adjustment.",
                "is_key_excerpt": False,
            },
            {
                "excerpt_label": "§1402(a)(13) split + entity 14a (lines 3b/4b/3c/4c → 14a)",
                "location_reference": "i1065 (2025) p.45, SE Worksheet lines 3b-4c",
                "excerpt_text": (
                    "Line 3b removes limited partners' distributive share; line 4b removes the part of line "
                    "4a (guaranteed payments) allocated to limited partners for other than services (their "
                    "capital GP); services GP is retained on line 4c; general partners keep line 3c plus the "
                    "full 4c. Entity Schedule K line 14a = line 3c + line 4c."
                ),
                "summary_text": "Entity 14a = 3c + 4c; the worksheet's mechanical 'limited partner' label at "
                                "3b/4b is what this spec replaces with se_classification.",
                "is_key_excerpt": True,
            },
        ],
    },
...
FORM_IDENTITY = {
    ...
    "notes": (
        ...
        "path). OUT OF SCOPE (spec §14): the SE-base definition itself (i1065 worksheet 1a-3a "
        "Form-4797/rental adjustments) and K-1 14b/14c."
    ),
}
...
FACTS: list[dict] = [
    ...
    {"fact_key": "se_box1_ordinary", "label": "Distributive share of ordinary business income (box 1)",
     "data_type": "decimal", "default_value": "0", "sort_order": 10,
     "notes": "The ordinary-income SE base for this partner (may be negative — a distributive-share loss). "
              "The base's full worksheet definition is out of scope (§14)."},
...
LINES: list[dict] = [
    ...
    {"line_number": "14a", "description": "Schedule K-1, box 14, code A — Partner's net earnings (loss) from "
     ...
     "source_rules": ["R-SE-DSHARE", "R-SE-GPSVC", "R-SE-GPCAP", "R-SE-DEFAULT", "R-SE-LOSS"],
     "destination_form": "SCHEDULE_SE",
     "notes": "Per-partner. 14b/14c (gross farming / nonfarm) are OUT OF SCOPE (§14). destination_form "
              "SCHEDULE_SE is the FUTURE flow-through gated by FLOW-14A-SE (inactive)."},
]
...
class Command(BaseCommand):
    ...
    def _load_flow_assertions(self):
        ...
        self.stdout.write(f"  {len(FLOW_ASSERTIONS)} flow assertions "
                          f"(FLOW-14A-SE seeded status=disabled)")
